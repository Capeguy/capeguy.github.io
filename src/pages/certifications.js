...
const CertificationsPage = ({ location, data }) => {
          ...
          <table>
            <thead>
              <tr>
                <th>Year</th>
                <th>Certification</th>
                <th className="hide-on-mobile">Institution</th>
            ...
            <tbody>
              {projects.length > 0 &&
                projects.map(({ node }, i) => {
                  ...
                  return (
                    <tr
                      className="link-to-external-link"
                      key={i}
                    ...
                    >
                      ...
                      <td className="links">
                        <div>
                          {external && (
                            <a href={external} className="eternal-link" aria-label="External Link">
                              <Icon name="External" />
                            </a>
                          )}
                          {github && (
